...
// Project related.
var project                 = 'csoon'; // Project Name.
var projectURL              = 'localhost/csoon'; // Local project URL of your already running WordPress site. Could be something like local.dev or localhost:8888.
var productURL              = './'; // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.

// Translation related.
var text_domain             = 'csoon'; // Your textdomain here.
var translationFile         = 'csoon.pot'; // Name of the transalation file.
var translationDestination  = './languages'; // Where to save the translation files.
var packageName             = 'csoon'; // Package name.
var bugReport               = 'https://AhmadAwais.com/contact/'; // Where can users report bugs.
var lastTranslator          = 'Pedro Protest <dev@crew.pt>'; // Last translator Email ID.
var team                    = 'CREW <dev@crew.pt>'; // Team's Email ID.

// Style related.
var styleSRC                = './assets/sass/*.sass'; // Path to main .scss file.
...
// Watch files paths.
var styleWatchFiles         = './assets/sass/**/*.sass'; // Path to all *.scss files inside css folder and inside them.
